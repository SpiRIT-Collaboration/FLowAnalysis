...
#include "FairRunAna.h"                 // for FairRunAna Base
...
class STRunAna : public FairRunAna
{

public:

  static STRunAna* Instance();
  virtual ~STRunAna();
  STRunAna();
...
private:
  ...
  STRunAna(const STRunAna& M);
  STRunAna& operator= (const  STRunAna&) {
    return *this;
  }
