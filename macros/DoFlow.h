...
Double_t yrange1[]    = {-0.5,  -0.25,  -0.20, -0.15,  -0.1,  -0.05,  0., 0.05,  0.1,  0.15,  0.2,  0.25,  0.3,  0.35,  0.45, 0.5}; //by v52.10
Double_t yrange1nrm[] = {-1.35, -0.675, -0.54, -0.404, -0.27, -0.135, 0., 0.135, 0.27, 0.404, 0.54, 0.675, 0.81, 0.944, 1.2,  1.35};
...
Double_t yrange2nrm[] = { -1.35, -0.675,  -0.27,  0.,  0.27,  0.675, 0.944, 1.35};
